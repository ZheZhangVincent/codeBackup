...
class Grounder(object):
    ...
    def rename_asp_components(self):
        ...
        #Types
        self.asp_types = {}
        for ttype in self.problem.types.itervalues():
            ttype.asp_name = asp_convert(ttype.name)
            self.asp_types[ttype.asp_name] = ttype
        
        #Objects
        for obj in self.problem.objects.itervalues():
        ...
        #Functions
        for func in self.problem.functions.itervalues():
    ...
    def write_asp(self):
        ...
        """
        with file(self.pre_file_name, 'w') as out_file:
           #Objects
           for obj in self.problem.objects.itervalues():
    ...
    def ground(self):
        ...
        try:
           ...
           with file(self.grounding_file_name) as grounding_file:
