...
class Action(object):
    ...
    def __dump__(self):
        ...
        out_str += "Pre:     " + " ".join(["("+str(f)+")" for f in self.preconditions]) + "\n"
        out_str += "Pos Eff: " + " ".join(["("+str(f)+")" for f in self.pos_effects]) + "\n"
        out_str += "Neg Eff: " + " ".join(["("+str(f)+")" for f in self.neg_effects]) + "\n"
        return out_str
